...
#include "neural_network_numbers.h"
#include "serializer_numbers.c"
...
void compute_image(char * datasetType) {
    ...
    neural_network_training_step(neural_network, images_set.pixels, images_set.label, 0, 1);
}